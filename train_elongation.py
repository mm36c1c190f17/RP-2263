...
# Теперь предсказываем эластичность (elongation)
X = data[['ingredient_a', 'ingredient_b', 'ingredient_c', 'temperature', 'time']]
y = data['elongation']  # ← изменили на эластичность
...
print("Обучаем модель CatBoost для эластичности...")
...
model.save_model('models/catboost_elongation.cbm')
print("\nМодель сохранена в папку models/catboost_elongation.cbm")